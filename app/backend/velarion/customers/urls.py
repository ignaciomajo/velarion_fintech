...
churn_prediction_resumen = ChurnPredictionViewSet.as_view({'get': 'resumen_riesgo'})
...
urlpatterns = [
    ...
    path('churn-prediction/resumen_riesgo/', churn_prediction_resumen, name='churn_prediction_resumen'),
]
